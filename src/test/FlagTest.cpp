    ...
    SECTION("misc format set flags") {
        ...
        SECTION("all affect flags") {
            ...
            SECTION("all set") {
                ...
                CHECK(
                    result
                    == "|Cblind invisible detect_evil detect_invis detect_magic detect_hidden talon sanctuary "
                       "faerie_fire "
