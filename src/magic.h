...
DECLARE_SPELL_FUN(spell_acid_wash);
...
DECLARE_SPELL_FUN(spell_remove_invisible);
...
DECLARE_SPELL_FUN(spell_octarine_fire);
...
DECLARE_SPELL_FUN(spell_tame_lightning);
DECLARE_SPELL_FUN(spell_teleport);
DECLARE_SPELL_FUN(spell_teleport_object);
DECLARE_SPELL_FUN(spell_undo_spell);
DECLARE_SPELL_FUN(spell_vampire);
DECLARE_SPELL_FUN(spell_vorpal);
