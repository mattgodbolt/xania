...
extern void do_sharpen(Char *ch, const char *arg);
extern void do_ride(Char *ch, const char *arg);
extern void do_dismount(Char *ch, const char *arg);
...
extern void do_autoassist(Char *ch, const char *arg);
extern void do_autoexit(Char *ch, const char *arg);
extern void do_autogold(Char *ch, const char *arg);
extern void do_autolist(Char *ch, const char *arg);
extern void do_autoloot(Char *ch, const char *arg);
extern void do_autopeek(Char *ch, const char *arg);
extern void do_autosac(Char *ch, const char *arg);
extern void do_autosplit(Char *ch, const char *arg);
...
extern void do_berserk(Char *ch, const char *arg);
extern void do_brandish(Char *ch, const char *arg);
extern void do_brief(Char *ch, const char *arg);
...
extern void do_changes(Char *ch, const char *arg);
extern void do_channels(const Char *ch, const char *argument);
extern void do_clone(Char *ch, const char *arg);
extern void do_close(Char *ch, const char *arg);
extern void do_colour(Char *ch, const char *arg);
extern void do_coma(Char *ch, const char *arg);
extern void do_commands(Char *ch, const char *argument);
extern void do_combine(Char *ch, const char *arg);
extern void do_compact(Char *ch, const char *arg);
extern void do_compare(Char *ch, const char *arg);
extern void do_consider(Char *ch, const char *arg);
extern void do_count(Char *ch, const char *arg);
extern void do_credits(Char *ch, const char *arg);
extern void do_delet(Char *ch, const char *arg);
extern void do_delete(Char *ch, const char *arg);
...
extern void do_disarm(Char *ch, const char *arg);
extern void do_disconnect(Char *ch, const char *arg);
extern void do_down(Char *ch, const char *arg);
...
extern void do_dump(Char *ch, const char *arg);
extern void do_east(Char *ch, const char *arg);
...
extern void do_flee(Char *ch, const char *arg);
extern void do_follow(Char *ch, std::string_view argument);
...
extern void do_hide(Char *ch, const char *arg);
extern void do_holylight(Char *ch, const char *arg);
...
extern void do_imotd(Char *ch, const char *arg);
extern void do_inventory(Char *ch, const char *arg);
...
extern void do_motd(Char *ch, const char *arg);
extern void do_murde(Char *ch, const char *arg);
extern void do_murder(Char *ch, const char *arg);
extern void do_music(Char *ch, const char *arg);
extern void do_newlock(Char *ch, const char *argument);
extern void do_nochannels(Char *ch, const char *arg);
extern void do_noemote(Char *ch, const char *arg);
extern void do_nofollow(Char *ch, const char *arg);
extern void do_noloot(Char *ch, const char *arg);
extern void do_north(Char *ch, const char *arg);
...
extern void do_pick(Char *ch, const char *arg);
extern void do_pose(Char *ch, const char *arg);
...
extern void do_qui(Char *ch, const char *arg);
...
extern void do_recall(Char *ch, const char *arg);
extern void do_recho(Char *ch, const char *arg);
extern void do_recite(Char *ch, const char *arg);
extern void do_refuse(Char *ch, const char *arg);
extern void do_remove(Char *ch, const char *arg);
extern void do_reply(Char *ch, const char *arg);
extern void do_report(Char *ch, const char *arg);
extern void do_rescue(Char *ch, const char *arg);
extern void do_rest(Char *ch, const char *arg);
extern void do_restore(Char *ch, const char *arg);
extern void do_return(Char *ch, const char *arg);
extern void do_rset(Char *ch, const char *argument);
extern void do_rstat(Char *ch, const char *arg);
extern void do_rules(Char *ch, const char *arg);
extern void do_sacname(Char *ch, const char *arg);
...
extern void do_showafk(Char *ch, const char *arg);
extern void do_showdefence(Char *ch, const char *arg);
extern void do_shutdow(Char *ch, const char *arg);
extern void do_shutdown(Char *ch, const char *arg);
extern void do_sit(Char *ch, const char *arg);
extern void do_skills(Char *ch, const char *argument);
extern void do_sla(Char *ch, const char *arg);
extern void do_slay(Char *ch, const char *arg);
extern void do_sleep(Char *ch, const char *arg);
extern void do_slookup(Char *ch, const char *arg);
extern void do_smit(Char *ch, const char *arg);
extern void do_smite(Char *ch, const char *arg);
extern void do_sneak(Char *ch, const char *arg);
extern void do_snoop(Char *ch, const char *arg);
extern void do_socials(Char *ch, const char *arg);
extern void do_south(Char *ch, const char *arg);
extern void do_sockets(Char *ch, const char *arg);
extern void do_spells(Char *ch, const char *arg);
extern void do_split(Char *ch, const char *arg);
extern void do_sset(Char *ch, const char *argument);
extern void do_stand(Char *ch, const char *arg);
extern void do_stat(Char *ch, const char *arg);
extern void do_steal(Char *ch, const char *arg);
extern void do_story(Char *ch, const char *arg);
...
extern void do_time(Char *ch, const char *arg);
extern void do_tipwizard(Char *ch, const char *arg);
extern void do_title(Char *ch, const char *arg);
extern void do_train(Char *ch, const char *argument);
extern void do_transfer(Char *ch, std::string_view argument);
...
extern void do_unlock(Char *ch, const char *arg);
extern void do_up(Char *ch, const char *arg);
extern void do_value(Char *ch, const char *arg);
extern void do_visible(Char *ch, const char *arg);
extern void do_vnum(Char *ch, const char *arg);
extern void do_wake(Char *ch, const char *arg);
extern void do_wear(Char *ch, const char *arg);
extern void do_weather(Char *ch, const char *argument);
extern void do_west(Char *ch, const char *arg);
extern void do_where(Char *ch, const char *arg);
extern void do_scan(Char *ch, const char *arg);
extern void do_who(Char *ch, const char *arg);
extern void do_whois(Char *ch, std::string_view argument);
extern void do_wimpy(Char *ch, const char *arg);
extern void do_wizhelp(Char *ch, const char *argument);
extern void do_wizlock(Char *ch, const char *argument);
extern void do_wizlist(Char *ch, const char *arg);
extern void do_wiznet(Char *ch, const char *arg);
extern void do_worth(Char *ch, const char *arg);
...
extern void do_timezone(Char *ch, const char *arg); /* 'timezone' added PCFN 24-05-97 */
...
extern void do_clanwho(Char *ch, const char *arg);
