...
#define ITEM_EXTRA_FLAGS "glow hum dark lock evil invis magic nodrop bless antigood antievil antineutral " \
...
#define ROOM_FLAGS "dark * nomob indoors * * * * * private safe solitary petshop norecall 100imponly 92godonly " \
...
AFFECT_DATA *
        find_affect     args( ( CHAR_DATA *ch, int sn ) );
