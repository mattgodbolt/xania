...
void do_ostat( CHAR_DATA *ch, char *argument )
{
   ...
   case ITEM_WAND:
   case ITEM_STAFF:
      bug_snprintf( buf, sizeof(buf), "Has %d(%d) charges of level %d",
   ...
   case ITEM_WEAPON:
      ...
      {
         case(DAM_NONE):
         bug_snprintf(buf, sizeof(buf), "none.\n\r");
         break;
         case(DAM_BASH):
         bug_snprintf(buf, sizeof(buf), "bash.\n\r");
         break;
         case(DAM_PIERCE):
         bug_snprintf(buf, sizeof(buf), "pierce.\n\r");
         break;
         case(DAM_SLASH):
         bug_snprintf(buf, sizeof(buf), "slash.\n\r");
         break;
         case(DAM_FIRE):
         bug_snprintf(buf, sizeof(buf), "fire.\n\r");
         break;
         case(DAM_COLD):
         bug_snprintf(buf, sizeof(buf), "cold.\n\r");
         break;
         case(DAM_LIGHTNING):
         bug_snprintf(buf, sizeof(buf), "lightning.\n\r");
         break;
         case(DAM_ACID):
         bug_snprintf(buf, sizeof(buf), "acid.\n\r");
         break;
         case(DAM_POISON):
         bug_snprintf(buf, sizeof(buf), "poison.\n\r");
         break;
         case(DAM_NEGATIVE):
         bug_snprintf(buf, sizeof(buf), "negative.\n\r");
         break;
         case(DAM_HOLY):
         bug_snprintf(buf, sizeof(buf), "holy.\n\r");
         break;
         case(DAM_ENERGY):
         bug_snprintf(buf, sizeof(buf), "energy.\n\r");
         break;
         case(DAM_MENTAL):
         bug_snprintf(buf, sizeof(buf), "mental.\n\r");
         break;
         case(DAM_DISEASE):
         bug_snprintf(buf, sizeof(buf), "disease.\n\r");
         break;
         case(DAM_DROWNING):
         bug_snprintf(buf, sizeof(buf), "drowning.\n\r");
         break;
         case(DAM_LIGHT):
         bug_snprintf(buf, sizeof(buf), "light.\n\r");
         break;
         case(DAM_OTHER):
         bug_snprintf(buf, sizeof(buf), "other.\n\r");
         break;
         case(DAM_HARM):
         bug_snprintf(buf, sizeof(buf), "harm.\n\r");
         break;
      default:
  ...
  if ( ( victim = get_char_world( ch, argument ) ) == NULL )
   ...
   for ( sn = 0; sn < MAX_SKILL; sn++ )
	 ...
	 continue;
       ...
       bug_snprintf( buf, sizeof(buf), "%-18s %3d%%  ",
